...
const sections: FeatureSection[] = [
  ...
  { id: "household", eyebrow: "Keep your household aligned", title: "Turn financial complexity into a useful conversation.", body: "Report Builder creates clear plans and reviews for a partner or household member. The iPhone companion opens the same finance-document format for selected Forecast, Reports and Financial To-Do workflows.", bullets: ["Weekly Family Plan", "Weekly Spending Review", "Weekly Money Check-In", "Month-End Money Review", "Selected iPhone companion workflows"] },
];
